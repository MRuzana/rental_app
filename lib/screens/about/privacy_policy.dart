          ...
          child: RichText(
            text: TextSpan(
              children: <TextSpan>[
                ...
                const TextSpan(
                  text:
                      '''\nThank you for using Rental App,. This Privacy Policy is designed to help you understand how we collect, use, and safeguard the information you provide to us through the App.\n''',
                  style: TextStyle(
                    fontSize: 13,
                    color: Colors.black,
                    height: 1.5,
                ...
                const TextSpan(
                  text:
                      '''\nThe App may request access to your device's camera to provide features that require image capture. We do not store or transmit any media captured through the camera without your explicit consent.\n''',
                  style: TextStyle(
                    fontSize: 13,
                    color: Colors.black,
                    height: 1.5,
                ...
                const TextSpan(
                  text:
                      '''\nThe App may require internet access to function properly.\n''',
                  style: TextStyle(
                    fontSize: 13,
                    color: Colors.black,
                    height: 1.5,
                ...
                const TextSpan(
                  text:
                      '''\nCamera data collected by the App is used solely for the purpose of providing features that require image capture. We do not share or distribute this data to third parties unless required by law.\n''',
                  style: TextStyle(
                    fontSize: 13,
                    color: Colors.black,
                    height: 1.5,
